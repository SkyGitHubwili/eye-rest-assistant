...
$ProjectRoot = 'F:\SleepAssistantBuild\android'
...
$OutputDir = 'F:\SleepAssistantRelease'

if (-not $ProjectRoot.StartsWith('F:\SleepAssistantBuild\', [System.StringComparison]::OrdinalIgnoreCase)) {
    throw 'Staging directory escaped the expected F:\SleepAssistantBuild folder.'
}
